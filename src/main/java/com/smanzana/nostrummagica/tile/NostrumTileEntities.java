...
public class NostrumTileEntities {
	...
	public static void registerTileEntities(RegistryEvent.Register<TileEntityType<?>> event) {
		...
		register(registry, TileEntityType.Builder.of(SpellTableTileEntity::new, NostrumBlocks.spellTable).build(null), ID_SpellTableEntity);
		register(registry, TileEntityType.Builder.of(SingleSpawnerTileEntity::new, NostrumBlocks.singleSpawner).build(null), ID_SingleSpawnerTileEntity);
		register(registry, TileEntityType.Builder.of(MatchSpawnerTileEntity::new, NostrumBlocks.matchSpawner).build(null), ID_MatchSpawnerTileEntity);
		register(registry, TileEntityType.Builder.of(TriggeredMatchSpawnerTileEntity::new, NostrumBlocks.triggeredMatchSpawner).build(null), ID_TriggeredMatchSpawnerTileEntity);
		register(registry, TileEntityType.Builder.of(AltarTileEntity::new, NostrumBlocks.altar).build(null), ID_AltarTileEntity);
		register(registry, TileEntityType.Builder.of(CandleTileEntity::new, NostrumBlocks.candle).build(null), ID_CandleTileEntity);
		register(registry, TileEntityType.Builder.of(ObeliskTileEntity::new, NostrumBlocks.obelisk).build(null), ID_NostrumObeliskEntity);
		register(registry, TileEntityType.Builder.of(ObeliskPortalTileEntity::new, NostrumBlocks.obeliskPortal).build(null), ID_ObeliskPortalTileEntity);
		register(registry, TileEntityType.Builder.of(ModificationTableTileEntity::new, NostrumBlocks.modificationTable).build(null), ID_ModificationTableEntity);
		register(registry, TileEntityType.Builder.of(LoreTableTileEntity::new, NostrumBlocks.loreTable).build(null), ID_LoreTableEntity);
		register(registry, TileEntityType.Builder.of(SorceryPortalTileEntity::new, NostrumBlocks.sorceryPortal).build(null), ID_SorceryPortalTileEntity);
		register(registry, TileEntityType.Builder.of(TeleportationPortalTileEntity::new, NostrumBlocks.teleportationPortal).build(null), ID_TeleportationPortalTileEntity);
		register(registry, TileEntityType.Builder.of(TemporaryPortalTileEntity::new, NostrumBlocks.temporaryTeleportationPortal).build(null), ID_TemporaryPortalTileEntity);
		register(registry, TileEntityType.Builder.of(ProgressionDoorTileEntity::new, NostrumBlocks.progressionDoor).build(null), ID_ProgressionDoorTileEntity);
		register(registry, TileEntityType.Builder.of(SwitchBlockTileEntity::new, NostrumBlocks.switchBlock).build(null), ID_SwitchBlockTileEntity);
		register(registry, TileEntityType.Builder.of(TeleportRuneTileEntity::new, NostrumBlocks.teleportRune).build(null), ID_TeleportRuneTileEntity);
		register(registry, TileEntityType.Builder.of(PutterBlockTileEntity::new, NostrumBlocks.putterBlock).build(null), ID_PutterBlockTileEntity);
		register(registry, TileEntityType.Builder.of(ActiveHopperTileEntity::new, NostrumBlocks.activeHopper).build(null), ID_ActiveHopperTileEntity);
		register(registry, TileEntityType.Builder.of(ItemDuctTileEntity::new, NostrumBlocks.itemDuct).build(null), ID_ItemDuctTileEntity);
		register(registry, TileEntityType.Builder.of(ParadoxMirrorTileEntity::new, NostrumBlocks.paradoxMirror).build(null), ID_ParadoxMirrorTileEntity);
		register(registry, TileEntityType.Builder.of(ManaArmorerTileEntity::new, NostrumBlocks.manaArmorerBlock).build(null), ID_ManaArmorerTileEntity);
		register(registry, TileEntityType.Builder.of(MimicBlockTileEntity::new, NostrumBlocks.mimicDoor, NostrumBlocks.mimicFacade, NostrumBlocks.mimicDoorUnbreakable, NostrumBlocks.mimicFacadeUnbreakable).build(null), ID_MimicBlockTileEntity);
		register(registry, TileEntityType.Builder.of(RuneShaperTileEntity::new, NostrumBlocks.runeShaper).build(null), ID_RuneShaper);
		register(registry, TileEntityType.Builder.of(LockedChestTileEntity::new, NostrumBlocks.lockedChest).build(null), ID_LockedChest);
		register(registry, TileEntityType.Builder.of(KeySwitchBlockTileEntity::new, NostrumBlocks.keySwitch).build(null), ID_KeySwitch);
		register(registry, TileEntityType.Builder.of(TrialBlockTileEntity::new, NostrumBlocks.trialBlock).build(null), ID_TrialBlockTileEntity);
		register(registry, TileEntityType.Builder.of(TriggerRepeaterTileEntity::new, NostrumBlocks.triggerRepeater, NostrumBlocks.redstoneTrigger).build(null), ID_TriggerRepeaterTileEntity);
		register(registry, TileEntityType.Builder.of(DelayLoadedMimicBlockTileEntity::new, NostrumBlocks.mimicDoor, NostrumBlocks.mimicFacade, NostrumBlocks.mimicDoorUnbreakable, NostrumBlocks.mimicFacadeUnbreakable).build(null), ID_DelayedMimicBlockTileEntity);
		register(registry, TileEntityType.Builder.of(BasicSpellTableTileEntity::new, NostrumBlocks.basicSpellTable).build(null), ID_BasicSpellTableTileEntity);
		register(registry, TileEntityType.Builder.of(AdvancedSpellTableTileEntity::new, NostrumBlocks.advancedSpellTable).build(null), ID_AdvancedSpellTableTileEntity);
		register(registry, TileEntityType.Builder.of(MysticSpellTableTileEntity::new, NostrumBlocks.mysticSpellTable).build(null), ID_MysticSpellTableTileEntity);
		register(registry, TileEntityType.Builder.of(RuneLibraryTileEntity::new, NostrumBlocks.runeLibrary).build(null), ID_RuneLibraryTileEntity);
		register(registry, TileEntityType.Builder.of(LockedDoorTileEntity::new, NostrumBlocks.lockedDoor).build(null), ID_LockedDoor);
		register(registry, TileEntityType.Builder.of(ShrineTileEntity.Element::new, NostrumBlocks.elementShrineBlock).build(null), ID_ElementShrine);
		register(registry, TileEntityType.Builder.of(ShrineTileEntity.Alteration::new, NostrumBlocks.alterationShrineBlock).build(null), ID_AlterationShrine);
		register(registry, TileEntityType.Builder.of(ShrineTileEntity.Shape::new, NostrumBlocks.shapeShrineBlock).build(null), ID_ShapeShrine);
		register(registry, TileEntityType.Builder.of(ShrineTileEntity.Tier::new, NostrumBlocks.tierShrineBlock).build(null), ID_TierShrine);
		register(registry, TileEntityType.Builder.of(DungeonLauncherTileEntity::new, NostrumBlocks.dungeonLauncher).build(null), ID_DungeonLauncher);
		register(registry, TileEntityType.Builder.of(CursedGlassTileEntity::new, NostrumBlocks.cursedGlass).build(null), ID_CursedGlass);
		register(registry, TileEntityType.Builder.of(DungeonKeyChestTileEntity::new, NostrumBlocks.smallDungeonKeyChest, NostrumBlocks.largeDungeonKeyChest).build(null), ID_DungeonKeyChest);
		register(registry, TileEntityType.Builder.of(DungeonDoorTileEntity::new, NostrumBlocks.smallDungeonDoor, NostrumBlocks.largeDungeonDoor).build(null), ID_DungeonDoor);
    }
}
