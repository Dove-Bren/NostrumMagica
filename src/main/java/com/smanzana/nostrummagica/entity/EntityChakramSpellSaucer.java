...
public class EntityChakramSpellSaucer extends EntitySpellSaucer {
	...
	protected EntityChakramSpellSaucer(EntityType<? extends EntityChakramSpellSaucer> type, ISpellProjectileShape trigger, World world, LivingEntity shooter, float speed, double maxDistance) {
		super(type, trigger, world, shooter, speed, maxDistance);
	}
	
	protected EntityChakramSpellSaucer(EntityType<? extends EntityChakramSpellSaucer> type, ISpellProjectileShape trigger, World world, LivingEntity shooter,
...
//        }
	...
	public EntityChakramSpellSaucer(ISpellProjectileShape trigger, World world, LivingEntity shooter, float speed, double maxDistance) {
		super(NostrumEntityTypes.chakramSpellSaucer, trigger, world, shooter, speed, maxDistance);
	}
	
	public EntityChakramSpellSaucer(ISpellProjectileShape trigger, World world, LivingEntity shooter,
			Vector3d from, Vector3d direction,
			float speedFactor, double maxDistance) {
