...
public abstract class EntityTileProxyTrigger<E extends EntityProxiedTileEntity<?>> extends MobEntity {
	
	private BlockPos cachePos;
	private E cacheEntity;
	
	protected EntityTileProxyTrigger(EntityType<? extends EntityTileProxyTrigger<E>> type, World worldIn) {
		super(type, worldIn);
		cachePos = null;
		cacheEntity = null;
