...
public class LightningAttackEffect extends Effect {
	...
	public LightningAttackEffect() {
		...
		this.addAttributesModifier(SharedMonsterAttributes.ATTACK_DAMAGE, "3AA5821F-0F7B-4E94-BF6C-7A58449F587B", 5.0D, AttributeModifier.Operation.ADDITION);
		this.addAttributesModifier(SharedMonsterAttributes.MOVEMENT_SPEED, "45e147fd-c876-48f2-b65a-6454fe86b46d".toUpperCase(), -0.5D, AttributeModifier.Operation.MULTIPLY_TOTAL);
	}
