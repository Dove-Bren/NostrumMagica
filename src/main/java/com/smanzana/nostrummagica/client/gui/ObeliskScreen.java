...
public class ObeliskScreen extends GuiScreen {
	...
	public void drawScreen(int parWidth, int parHeight, float p_73863_3_) {
		...
		this.fontRenderer.drawString("<" + xOffset + "," + yOffset + ">", 5, 5, 0xFFFFFF);
		this.fontRenderer.drawString("Scale: " + this.scale, 5, 20, 0xFFFFFFFF);
            ...
            if (visible)
            {
                ...
                if (!isCenter) {
                	...
                	if (isListed) {
                		...
                		// Draw above
                		int newX = x + (buttonWidth / 2) - (textWidth / 2);
                		fonter.drawString(title, newX, y - (5 + fonter.FONT_HEIGHT), color);
                	}
