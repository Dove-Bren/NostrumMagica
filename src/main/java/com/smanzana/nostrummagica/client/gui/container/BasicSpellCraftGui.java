...
public class BasicSpellCraftGui {
	...
	public static class BasicSpellCraftContainer extends SpellCreationContainer {
		...
		public static final BasicSpellCraftContainer FromNetwork(int windowId, PlayerInventory playerInv, PacketBuffer buffer) {
			final TileEntity te = ContainerUtil.GetPackedTE(buffer);
			final ISpellCraftingInventory tableInv = ((ISpellCraftingTileEntity) te).getSpellCraftingInventory();
		...
		public static IPackedContainerProvider Make(TileEntity table) {
			return ContainerUtil.MakeProvider(ID, (windowId, playerInv, player) -> {
				return new BasicSpellCraftContainer(windowId, player, playerInv, ((ISpellCraftingTileEntity) table).getSpellCraftingInventory(), table.getPos());
			}, (buffer) -> {
