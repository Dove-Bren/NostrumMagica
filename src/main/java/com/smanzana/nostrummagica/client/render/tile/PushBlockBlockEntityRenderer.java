...
public class PushBlockBlockEntityRenderer extends BlockEntityRendererBase<PushBlockTileEntity> {

	private static final ResourceLocation TEX = NostrumMagica.Loc("textures/entity/cursed_glass.png");
	
	public PushBlockBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
		super(context);
	}
