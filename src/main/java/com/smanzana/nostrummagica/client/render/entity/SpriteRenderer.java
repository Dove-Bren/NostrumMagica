...
import com.smanzana.nostrummagica.client.model.SpriteCoreModel;
...
public class SpriteRenderer extends MobRenderer<SpriteEntity, SpriteCoreModel> {

	public SpriteRenderer(EntityRendererProvider.Context renderManagerIn, float shadowSizeIn) {
		super(renderManagerIn, new SpriteCoreModel(), shadowSizeIn);
	}
