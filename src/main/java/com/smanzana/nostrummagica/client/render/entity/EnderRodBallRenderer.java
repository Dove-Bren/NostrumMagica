...
public class EnderRodBallRenderer extends EntityRenderer<EnderRodBallEntity> {
	
	private static final ResourceLocation BALL_MODEL = new ResourceLocation(NostrumMagica.MODID, "entity/koid");
	
	protected BakedModel<EnderRodBallEntity> ballOrb;

	public EnderRodBallRenderer(EntityRendererProvider.Context renderManagerIn) {
		super(renderManagerIn);
		this.ballOrb = new BakedModel<>(NostrumRenderTypes::GetBlendedEntity, BALL_MODEL);
	}
