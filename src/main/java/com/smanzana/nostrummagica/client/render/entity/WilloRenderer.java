...
import com.smanzana.nostrummagica.client.model.WilloModel;
...
public class WilloRenderer extends MobRenderer<WilloEntity, RenderShivModel<WilloEntity>> {

	private static final ResourceLocation RES_TEXT = new ResourceLocation(NostrumMagica.MODID, "textures/entity/willo.png");
	
	private WilloModel mainModel;
	
	public WilloRenderer(EntityRendererProvider.Context renderManagerIn, float scale) {
		super(renderManagerIn, new RenderShivModel<WilloEntity>(RenderType::entityCutoutNoCull), .33f);
		mainModel = new WilloModel(renderManagerIn.bakeLayer(NostrumModelLayers.Willo));
	}
