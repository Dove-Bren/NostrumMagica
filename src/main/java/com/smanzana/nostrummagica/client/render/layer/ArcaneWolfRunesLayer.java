...
public class ArcaneWolfRunesLayer extends RenderLayer<ArcaneWolfEntity, ArcaneWolfModel> {
	...
	private final ArcaneWolfRenderer wolfRenderer;
	
	public ArcaneWolfRunesLayer(ArcaneWolfRenderer wolfRenderer) {
		super(wolfRenderer);
