...
public class RenderSpellProjectile extends EntityRenderer<EntitySpellProjectile> {
	...
	@Override
	public void render(EntitySpellProjectile entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		...
		IVertexBuilder buffer = bufferIn.getBuffer(RenderType.getEntityTranslucent(getEntityTexture(entityIn)));
