...
public class LayerArmorElytra<T extends LivingEntity, M extends EntityModel<T>> extends ElytraLayer<T, M> {

	public LayerArmorElytra(RenderLayerParent<T, M> renderer, EntityModelSet models) {
