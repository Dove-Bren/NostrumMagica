...
import com.smanzana.nostrummagica.client.model.DragonEggModel;
...
public class DragonEggRenderer extends MobRenderer<DragonEggEntity, DragonEggModel> {

	public DragonEggRenderer(EntityRendererProvider.Context renderManagerIn, float shadowSizeIn) {
		super(renderManagerIn, new DragonEggModel(renderManagerIn.bakeLayer(NostrumModelLayers.DragonEgg)), shadowSizeIn);
	}
