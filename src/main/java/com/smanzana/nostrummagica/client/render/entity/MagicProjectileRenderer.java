...
public class MagicProjectileRenderer extends EntityRenderer<MagicDamageProjectileEntity> {
	...
	public MagicProjectileRenderer(EntityRendererProvider.Context renderManager, float scale) {
		super(renderManager);
		this.scale = scale;
	}
	...
	@Override
	public void render(MagicDamageProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
