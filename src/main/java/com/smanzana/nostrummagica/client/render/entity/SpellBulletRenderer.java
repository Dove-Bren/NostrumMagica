...
public class SpellBulletRenderer extends EntityRenderer<SpellBulletEntity> {
	...
	public SpellBulletRenderer(EntityRendererProvider.Context renderManager, float scale) {
		super(renderManager);
		this.scale = scale;
	}
