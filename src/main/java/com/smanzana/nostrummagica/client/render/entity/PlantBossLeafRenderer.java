...
public class PlantBossLeafRenderer extends EntityRenderer<PlantBossEntity.PlantBossLeafLimb> {
	...
	protected PlantBossLeafModel mainModel;
	
	public PlantBossLeafRenderer(EntityRendererProvider.Context renderManagerIn) {
		super(renderManagerIn);
		
		mainModel = new PlantBossLeafModel(renderManagerIn.bakeLayer(NostrumModelLayers.PlantbossLeaf));
	}
