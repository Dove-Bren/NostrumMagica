...
public class ManaArmorLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
	...
	public ManaArmorLayer(PlayerRenderer renderPlayerIn) {
