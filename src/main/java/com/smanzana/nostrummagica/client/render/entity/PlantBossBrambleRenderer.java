...
import com.smanzana.nostrummagica.client.model.PlantBossBrambleModel;
...
public class PlantBossBrambleRenderer extends EntityRenderer<PlantBossBrambleEntity> {
	...
	protected PlantBossBrambleModel mainModel;
	
	public PlantBossBrambleRenderer(EntityRendererProvider.Context renderManagerIn) {
		super(renderManagerIn);
		
		mainModel = new PlantBossBrambleModel(renderManagerIn.bakeLayer(NostrumModelLayers.PlantbossBramble));
