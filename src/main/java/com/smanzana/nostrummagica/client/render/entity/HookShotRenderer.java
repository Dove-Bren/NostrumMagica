...
import com.smanzana.nostrummagica.client.model.HookShotModel;
...
public class HookShotRenderer extends EntityRenderer<HookShotEntity> {
	...
	private HookShotModel model;
	
	public HookShotRenderer(EntityRendererProvider.Context renderManagerIn) {
		super(renderManagerIn);
		
		this.model = new HookShotModel(renderManagerIn.bakeLayer(NostrumModelLayers.HookshotAnchor));
	}
