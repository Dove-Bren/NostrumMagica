...
public class TrialBlockEntityRenderer extends BlockEntityRendererBase<TrialBlockTileEntity> {

	public TrialBlockEntityRenderer(BlockEntityRendererProvider.Context rendererDispatcherIn) {
