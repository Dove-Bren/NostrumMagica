...
public class ManaArmorerBlockEntityRenderer extends BlockEntityRendererBase<ManaArmorerTileEntity> {

	public ManaArmorerBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
		super(context);
	}
