...
public abstract class ShrineTriggerRenderer<E extends ShrineTriggerEntity<?>> extends EntityRenderer<E> {
	...
	public ShrineTriggerRenderer(EntityRendererProvider.Context renderManagerIn) {
	...
	protected static abstract class SpellComponentRender<E extends ShrineTriggerEntity<?>> extends ShrineTriggerRenderer<E> {
	...
	public static class Tier extends ShrineTriggerRenderer<ShrineTriggerEntity.Tier> {
