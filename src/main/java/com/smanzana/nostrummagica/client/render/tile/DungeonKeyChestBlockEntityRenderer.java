...
public class DungeonKeyChestBlockEntityRenderer extends BlockEntityRendererBase<DungeonKeyChestTileEntity> {
	...
	public DungeonKeyChestBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
		super(context);
	}
