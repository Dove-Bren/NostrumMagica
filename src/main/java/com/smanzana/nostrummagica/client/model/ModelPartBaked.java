 ...
 * @param <T>
 */
public class ModelPartBaked extends ModelPartClone {

	private final ResourceLocation modelLocation;
	private @Nullable BakedModel bakedModel;
	private boolean loaded;
	
	public ModelPartBaked(ResourceLocation modelLocation) {
	...
	private static final ModelPartClone.Cube MakeFauxCube() {
		...
		return new ModelPartClone.Cube(0, 0, 0, 0, 0, .1f, .1f, .1f, 0f, 0f, 0f, false, 1, 1); // last two params may need adjusting?
	}
