...
public class PartBakedWithOffsetModel extends PartBakedModel {
	
	private float offsetX;
	private float offsetY;
	private float offsetZ;
	
	public PartBakedWithOffsetModel(ResourceLocation model) {
		super(model);
	}
	
	public PartBakedWithOffsetModel(ResourceLocation model, float offsetX, float offsetY, float offsetZ) {
		this(model);
