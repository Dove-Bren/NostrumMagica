...
public class ModelPartClone {
	public float x;
	   ...
	   private final List<ModelPartClone.Cube> cubes;
	   private final Map<String, ModelPartClone> children;

	   public ModelPartClone(List<ModelPartClone.Cube> p_171306_, Map<String, ModelPartClone> p_171307_) {
	   ...
	   public void copyFrom(ModelPartClone p_104316_) {
	   ...
	   public void render(PoseStack p_104307_, VertexConsumer p_104308_, int p_104309_, int p_104310_, float p_104311_, float p_104312_, float p_104313_, float p_104314_) {
		  if (this.visible) {
			 if (!this.cubes.isEmpty() || !this.children.isEmpty()) {
				...
				for(ModelPartClone ModelPartClone : this.children.values()) {
	   ...
	   public void visit(PoseStack p_171310_, ModelPartClone.Visitor p_171311_) {
		  this.visit(p_171310_, p_171311_, "");
	   }

	   private void visit(PoseStack p_171313_, ModelPartClone.Visitor p_171314_, String p_171315_) {
		  if (!this.cubes.isEmpty() || !this.children.isEmpty()) {
			 p_171313_.pushPose();
	   ...
	   public void compile(PoseStack.Pose p_104291_, VertexConsumer p_104292_, int p_104293_, int p_104294_, float p_104295_, float p_104296_, float p_104297_, float p_104298_) {
		  for(ModelPartClone.Cube ModelPartClone$cube : this.cubes) {
			 ModelPartClone$cube.compile(p_104291_, p_104292_, p_104293_, p_104294_, p_104295_, p_104296_, p_104297_, p_104298_);
		  }

	   }

	   public ModelPartClone.Cube getRandomCube(Random p_104329_) {
	   ...
	   public Stream<ModelPartClone> getAllParts() {
		  return Stream.concat(Stream.of(this), this.children.values().stream().flatMap(ModelPartClone::getAllParts));
	   }

	   @OnlyIn(Dist.CLIENT)
	   public static class Cube {
		  private final ModelPartClone.Polygon[] polygons;
		  ...
		  public Cube(int u, int v, float x, float y, float z, float wx, float wy, float wz, float growX, float growY, float growZ, boolean mirror, float p_104355_, float p_104356_) {
			 ...
			 this.maxY = y + wy;
			 this.maxZ = z + wz;
			 this.polygons = new ModelPartClone.Polygon[6];
			 float f = x + wx;
			 float f1 = y + wy;
			 float f2 = z + wz;
			 x = x - growX;
			 ...
			 ModelPartClone.Vertex ModelPartClone$vertex7 = new ModelPartClone.Vertex(x, y, z, 0.0F, 0.0F);
			 ModelPartClone.Vertex ModelPartClone$vertex = new ModelPartClone.Vertex(f, y, z, 0.0F, 8.0F);
			 ModelPartClone.Vertex ModelPartClone$vertex1 = new ModelPartClone.Vertex(f, f1, z, 8.0F, 8.0F);
			 ModelPartClone.Vertex ModelPartClone$vertex2 = new ModelPartClone.Vertex(x, f1, z, 8.0F, 0.0F);
			 ModelPartClone.Vertex ModelPartClone$vertex3 = new ModelPartClone.Vertex(x, y, f2, 0.0F, 0.0F);
			 ModelPartClone.Vertex ModelPartClone$vertex4 = new ModelPartClone.Vertex(f, y, f2, 0.0F, 8.0F);
			 ModelPartClone.Vertex ModelPartClone$vertex5 = new ModelPartClone.Vertex(f, f1, f2, 8.0F, 8.0F);
			 ModelPartClone.Vertex ModelPartClone$vertex6 = new ModelPartClone.Vertex(x, f1, f2, 8.0F, 0.0F);
			 float f4 = (float)u;
			 float f5 = (float)u + wz;
			 ...
			 this.polygons[2] = new ModelPartClone.Polygon(new ModelPartClone.Vertex[]{ModelPartClone$vertex4, ModelPartClone$vertex3, ModelPartClone$vertex7, ModelPartClone$vertex}, f5, f10, f6, f11, p_104355_, p_104356_, mirror, Direction.DOWN);
			 this.polygons[3] = new ModelPartClone.Polygon(new ModelPartClone.Vertex[]{ModelPartClone$vertex1, ModelPartClone$vertex2, ModelPartClone$vertex6, ModelPartClone$vertex5}, f6, f11, f7, f10, p_104355_, p_104356_, mirror, Direction.UP);
			 this.polygons[1] = new ModelPartClone.Polygon(new ModelPartClone.Vertex[]{ModelPartClone$vertex7, ModelPartClone$vertex3, ModelPartClone$vertex6, ModelPartClone$vertex2}, f4, f11, f5, f12, p_104355_, p_104356_, mirror, Direction.WEST);
			 this.polygons[4] = new ModelPartClone.Polygon(new ModelPartClone.Vertex[]{ModelPartClone$vertex, ModelPartClone$vertex7, ModelPartClone$vertex2, ModelPartClone$vertex1}, f5, f11, f6, f12, p_104355_, p_104356_, mirror, Direction.NORTH);
			 this.polygons[0] = new ModelPartClone.Polygon(new ModelPartClone.Vertex[]{ModelPartClone$vertex4, ModelPartClone$vertex, ModelPartClone$vertex1, ModelPartClone$vertex5}, f6, f11, f8, f12, p_104355_, p_104356_, mirror, Direction.EAST);
			 this.polygons[5] = new ModelPartClone.Polygon(new ModelPartClone.Vertex[]{ModelPartClone$vertex3, ModelPartClone$vertex4, ModelPartClone$vertex5, ModelPartClone$vertex6}, f8, f11, f9, f12, p_104355_, p_104356_, mirror, Direction.SOUTH);
		  }
		  ...
		  public void compile(PoseStack.Pose p_171333_, VertexConsumer p_171334_, int p_171335_, int p_171336_, float p_171337_, float p_171338_, float p_171339_, float p_171340_) {
			 ...
			 for(ModelPartClone.Polygon ModelPartClone$polygon : this.polygons) {
				...
				for(ModelPartClone.Vertex ModelPartClone$vertex : ModelPartClone$polygon.vertices) {
	   ...
	   static class Polygon {
		  public final ModelPartClone.Vertex[] vertices;
		  public final Vector3f normal;

		  public Polygon(ModelPartClone.Vertex[] p_104362_, float p_104363_, float p_104364_, float p_104365_, float p_104366_, float p_104367_, float p_104368_, boolean p_104369_, Direction p_104370_) {
			 ...
			 if (p_104369_) {
				...
				for(int j = 0; j < i / 2; ++j) {
				   ModelPartClone.Vertex ModelPartClone$vertex = p_104362_[j];
	   ...
	   static class Vertex {
		  ...
		  public ModelPartClone.Vertex remap(float p_104385_, float p_104386_) {
			 return new ModelPartClone.Vertex(this.pos, p_104385_, p_104386_);
		  }
