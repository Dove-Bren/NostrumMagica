...
public class NostrumFluids {
	...
	@ObjectHolder(PureWaterFluid.ID) public static PureWaterFluid.Source pureWater;
	@ObjectHolder(PureWaterFluid.ID_FLOWING) public static PureWaterFluid.Flowing pureWaterFlowing;
    ...
    public static void registerFluidBlocks(RegistryEvent.Register<Fluid> event) {
		...
		registry.register(new PureWaterFluid.Source().setRegistryName(PureWaterFluid.ID));
		registry.register(new PureWaterFluid.Flowing().setRegistryName(PureWaterFluid.ID_FLOWING));
    }
    ...
    public static void registerFluidItems(RegistryEvent.Register<Item> event) {
    	...
    	registry.register(new BucketItem(() -> {return NostrumFluids.pureWater;}, NostrumItems.PropUnstackable())
    			.setRegistryName(PureWaterFluid.ID + "_bucket")
    			);
    }
}
