...
public class NostrumEffects {
	...
	@ObjectHolder(PhyShieldEffect.ID) public static PhyShieldEffect physicalShield;
	...
	@ObjectHolder(ElementalEnchantEffect.ID_NEUTRAL) public static ElementalEnchantEffect enchantNeutral;
	...
	@ObjectHolder(ElementalSpellBoostEffect.ID_NEUTRAL) public static ElementalSpellBoostEffect spellBoostNeutral;
    ...
    public static void registerPotions(RegistryEvent.Register<MobEffect> event) {
    	...
    	registry.register(new PhyShieldEffect().setRegistryName(PhyShieldEffect.ID));
    	...
    	registry.register(new ElementalEnchantEffect(EMagicElement.NEUTRAL).setRegistryName(ElementalEnchantEffect.ID_NEUTRAL));
    	...
    	registry.register(new ElementalSpellBoostEffect(EMagicElement.NEUTRAL).setRegistryName(ElementalSpellBoostEffect.ID_NEUTRAL));
