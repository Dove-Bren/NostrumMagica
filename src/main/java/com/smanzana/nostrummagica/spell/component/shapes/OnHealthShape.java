...
public class OnHealthShape extends SpellShape {
	...
	@Override
	public HealthShapeInstance createInstance(ISpellState state, World world, Vector3d pos, float pitch, float yaw, SpellShapePartProperties params, SpellCharacteristics characteristics) {
