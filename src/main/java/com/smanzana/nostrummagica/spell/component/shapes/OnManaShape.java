...
public class OnManaShape extends SpellShape {
	...
	@Override
	public ManaShapeInstance createInstance(ISpellState state, World world, Vector3d pos, float pitch, float yaw, SpellShapePartProperties params, SpellCharacteristics characteristics) {
