...
public class NostrumItems {
	...
	protected static final String ID_Scroll = "blank_scroll";
	protected static final String ID_EggFragment = "dragon_egg_part";
	protected static final String ID_MasteryOrb = "mastery_orb";
	protected static final String ID_TOKEN = "token";
	protected static final String ID_PENDANT_LEFT = "pendant_left";
	protected static final String ID_PENDANT_RIGHT = "pendant_right";
	protected static final String ID_SLAB_FIERCE = "slab_fierce";
	protected static final String ID_SLAB_KIND = "slab_kind";
	protected static final String ID_SLAB_BALANCED = "slab_balanced";
	protected static final String ID_SPRITE_CORE = "sprite_core";
	protected static final String ID_ENDER_BRISTLE = "ender_bristle";
	protected static final String ID_WISP_PEBBLE = "wisp_pebble";
	protected static final String ID_MANA_LEAF = "mana_leaf";
	protected static final String ID_EVIL_THISTLE = "evil_thistle";
	protected static final String ID_DRAGON_WING = "dragon_wing";
	protected static final String ID_SKILL_OOZE = "essential_ooze";
	protected static final String ID_SKILL_PENDANT = "eldrich_pendant";
	protected static final String ID_SKILL_FLUTE = "living_flute";
	
	@ObjectHolder(ArcaneWolfSoulItem.ID) public static ArcaneWolfSoulItem arcaneWolfSoulItem;
	@ObjectHolder(ID_Scroll) public static LoreItem blankScroll;
...
//	@ObjectHolder(DragonArmor.ID_CREST_DIAMOND) public static DragonArmor dragonArmorCrestDiamond;
	...
	@ObjectHolder(ID_EggFragment) public static LoreItem dragonEggFragment;
...
//	@ObjectHolder(MagicWindArmor.ID_FEET_ADEPT) public static MagicWindArmor enchantedArmorWindFeetAdept;
	...
	@ObjectHolder(ID_MasteryOrb) public static LoreItem masteryOrb;
	...
	@ObjectHolder(ID_TOKEN) public static LoreItem resourceToken;
	@ObjectHolder(ID_PENDANT_LEFT) public static LoreItem resourcePendantLeft;
	@ObjectHolder(ID_PENDANT_RIGHT) public static LoreItem resourcePendantRight;
	@ObjectHolder(ID_SLAB_FIERCE) public static LoreItem resourceSlabFierce;
	@ObjectHolder(ID_SLAB_KIND) public static LoreItem resourceSlabKind;
	@ObjectHolder(ID_SLAB_BALANCED) public static LoreItem resourceSlabBalanced;
	@ObjectHolder(ID_SPRITE_CORE) public static LoreItem resourceSpriteCore;
	@ObjectHolder(ID_ENDER_BRISTLE) public static LoreItem resourceEnderBristle;
	@ObjectHolder(ID_WISP_PEBBLE) public static LoreItem resourceWispPebble;
	@ObjectHolder(ID_MANA_LEAF) public static LoreItem resourceManaLeaf;
	@ObjectHolder(ID_EVIL_THISTLE) public static LoreItem resourceEvilThistle;
	@ObjectHolder(ID_DRAGON_WING) public static LoreItem resourceDragonWing;
	@ObjectHolder(ID_SKILL_OOZE) public static LoreItem resourceSkillOoze;
	@ObjectHolder(ID_SKILL_PENDANT) public static LoreItem resourceSkillPendant;
	@ObjectHolder(ID_SKILL_FLUTE) public static LoreItem resourceSkillFlute;
	...
	public static void registerItems(RegistryEvent.Register<Item> event) {
    	...
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_Scroll));
...
//    	register(registry, new DragonArmor(DragonEquipmentSlot.CREST, DragonArmorMaterial.DIAMOND).setRegistryName(DragonArmor.ID_CREST_DIAMOND));
    	...
    	register(registry, new LoreItem(NostrumItems.PropBase().stacksTo(3).rarity(Rarity.RARE)).setRegistryName(ID_EggFragment));
    	register(registry, new DragonSoulItem().setRegistryName(DragonSoulItem.ID));
    	
    	register(registry, new ElementalEarthArmor(EquipmentSlot.HEAD, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_HELM_NOVICE));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.HEAD, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_HELM_ADEPT));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.HEAD, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_HELM_MASTER));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.CHEST, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_CHEST_NOVICE));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.CHEST, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_CHEST_ADEPT));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.CHEST, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_CHEST_MASTER));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.LEGS, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_LEGS_NOVICE));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.LEGS, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_LEGS_ADEPT));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.LEGS, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_LEGS_MASTER));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.FEET, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_FEET_NOVICE));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.FEET, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_FEET_ADEPT));
    	register(registry, new ElementalEarthArmor(EquipmentSlot.FEET, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalEarthArmor.ID_FEET_MASTER));
    	
    	register(registry, new ElementalEnderArmor(EquipmentSlot.HEAD, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_HELM_NOVICE));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.HEAD, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_HELM_ADEPT));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.HEAD, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_HELM_MASTER));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.CHEST, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_CHEST_NOVICE));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.CHEST, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_CHEST_ADEPT));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.CHEST, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_CHEST_MASTER));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.LEGS, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_LEGS_NOVICE));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.LEGS, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_LEGS_ADEPT));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.LEGS, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_LEGS_MASTER));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.FEET, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_FEET_NOVICE));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.FEET, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_FEET_ADEPT));
    	register(registry, new ElementalEnderArmor(EquipmentSlot.FEET, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalEnderArmor.ID_FEET_MASTER));
    	
    	register(registry, new ElementalFireArmor(EquipmentSlot.HEAD, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalFireArmor.ID_HELM_NOVICE));
    	register(registry, new ElementalFireArmor(EquipmentSlot.HEAD, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalFireArmor.ID_HELM_ADEPT));
    	register(registry, new ElementalFireArmor(EquipmentSlot.HEAD, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalFireArmor.ID_HELM_MASTER));
    	register(registry, new ElementalFireArmor(EquipmentSlot.CHEST, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalFireArmor.ID_CHEST_NOVICE));
    	register(registry, new ElementalFireArmor(EquipmentSlot.CHEST, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalFireArmor.ID_CHEST_ADEPT));
    	register(registry, new ElementalFireArmor(EquipmentSlot.CHEST, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalFireArmor.ID_CHEST_MASTER));
    	register(registry, new ElementalFireArmor(EquipmentSlot.LEGS, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalFireArmor.ID_LEGS_NOVICE));
    	register(registry, new ElementalFireArmor(EquipmentSlot.LEGS, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalFireArmor.ID_LEGS_ADEPT));
    	register(registry, new ElementalFireArmor(EquipmentSlot.LEGS, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalFireArmor.ID_LEGS_MASTER));
    	register(registry, new ElementalFireArmor(EquipmentSlot.FEET, ElementalArmor.Type.NOVICE, PropEquipment()).setRegistryName(ElementalFireArmor.ID_FEET_NOVICE));
    	register(registry, new ElementalFireArmor(EquipmentSlot.FEET, ElementalArmor.Type.ADEPT, PropEquipment()).setRegistryName(ElementalFireArmor.ID_FEET_ADEPT));
    	register(registry, new ElementalFireArmor(EquipmentSlot.FEET, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalFireArmor.ID_FEET_MASTER));
...
//    	register(registry, new MagicIceArmor(EquipmentSlotType.HEAD, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicIceArmor.ID_HELM_ADEPT));
    	register(registry, new ElementalIceArmor(EquipmentSlot.HEAD, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalIceArmor.ID_HELM_MASTER));
...
//    	register(registry, new MagicIceArmor(EquipmentSlotType.CHEST, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicIceArmor.ID_CHEST_ADEPT));
    	register(registry, new ElementalIceArmor(EquipmentSlot.CHEST, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalIceArmor.ID_CHEST_MASTER));
...
//    	register(registry, new MagicIceArmor(EquipmentSlotType.LEGS, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicIceArmor.ID_LEGS_ADEPT));
    	register(registry, new ElementalIceArmor(EquipmentSlot.LEGS, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalIceArmor.ID_LEGS_MASTER));
...
//    	register(registry, new MagicIceArmor(EquipmentSlotType.FEET, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicIceArmor.ID_FEET_ADEPT));
    	register(registry, new ElementalIceArmor(EquipmentSlot.FEET, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalIceArmor.ID_FEET_MASTER));
...
//    	register(registry, new MagicLightningArmor(EquipmentSlotType.HEAD, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicLightningArmor.ID_HELM_ADEPT));
    	register(registry, new ElementalLightningArmor(EquipmentSlot.HEAD, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalLightningArmor.ID_HELM_MASTER));
...
//    	register(registry, new MagicLightningArmor(EquipmentSlotType.CHEST, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicLightningArmor.ID_CHEST_ADEPT));
    	register(registry, new ElementalLightningArmor(EquipmentSlot.CHEST, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalLightningArmor.ID_CHEST_MASTER));
...
//    	register(registry, new MagicLightningArmor(EquipmentSlotType.LEGS, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicLightningArmor.ID_LEGS_ADEPT));
    	register(registry, new ElementalLightningArmor(EquipmentSlot.LEGS, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalLightningArmor.ID_LEGS_MASTER));
...
//    	register(registry, new MagicWindArmor(EquipmentSlotType.HEAD, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicWindArmor.ID_HELM_ADEPT));
    	register(registry, new ElementalWindArmor(EquipmentSlot.HEAD, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalWindArmor.ID_HELM_MASTER));
...
//    	register(registry, new MagicWindArmor(EquipmentSlotType.CHEST, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicWindArmor.ID_CHEST_ADEPT));
    	register(registry, new ElementalWindArmor(EquipmentSlot.CHEST, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalWindArmor.ID_CHEST_MASTER));
...
//    	register(registry, new MagicWindArmor(EquipmentSlotType.LEGS, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicWindArmor.ID_LEGS_ADEPT));
    	register(registry, new ElementalWindArmor(EquipmentSlot.LEGS, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalWindArmor.ID_LEGS_MASTER));
...
//    	register(registry, new MagicWindArmor(EquipmentSlotType.FEET, MagicArmor.Type.ADEPT, PropEquipment()).setRegistryName(MagicWindArmor.ID_FEET_ADEPT));
    	register(registry, new ElementalWindArmor(EquipmentSlot.FEET, ElementalArmor.Type.MASTER, PropEquipment()).setRegistryName(ElementalWindArmor.ID_FEET_MASTER));
    	...
    	register(registry, new MageArmor(EquipmentSlot.HEAD, PropEquipment()).setRegistryName(MageArmor.ID_HELM));
    	register(registry, new MageArmor(EquipmentSlot.CHEST, PropEquipment()).setRegistryName(MageArmor.ID_CHEST));
    	register(registry, new MageArmor(EquipmentSlot.LEGS, PropEquipment()).setRegistryName(MageArmor.ID_LEGS));
    	register(registry, new MageArmor(EquipmentSlot.FEET, PropEquipment()).setRegistryName(MageArmor.ID_FEET));
    	...
    	register(registry, new LoreItem(NostrumItems.PropLowStack().rarity(Rarity.RARE)).setRegistryName(ID_MasteryOrb));
    	...
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_TOKEN));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_PENDANT_LEFT));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_PENDANT_RIGHT));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_SLAB_FIERCE));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_SLAB_KIND));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_SLAB_BALANCED));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_SPRITE_CORE));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_ENDER_BRISTLE));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_WISP_PEBBLE));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_MANA_LEAF));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_EVIL_THISTLE));
    	register(registry, new LoreItem(NostrumItems.PropBase()).setRegistryName(ID_DRAGON_WING));
    	register(registry, new SeekingGem(NostrumItems.PropEquipment()).setRegistryName(SeekingGem.ID));
    	register(registry, new LoreItem(NostrumItems.PropBase().rarity(Rarity.RARE)).setRegistryName(ID_SKILL_OOZE));
    	register(registry, new LoreItem(NostrumItems.PropBase().rarity(Rarity.RARE)).setRegistryName(ID_SKILL_PENDANT));
    	register(registry, new LoreItem(NostrumItems.PropBase().rarity(Rarity.RARE)).setRegistryName(ID_SKILL_FLUTE));
    	...
    	register(registry, new SpellTome(SpellTome.TomeStyle.NOVICE).setRegistryName(SpellTome.ID_PREFIX + SpellTome.TomeStyle.ID_SUFFIX_NOVICE));
    	register(registry, new SpellTome(SpellTome.TomeStyle.ADVANCED).setRegistryName(SpellTome.ID_PREFIX + SpellTome.TomeStyle.ID_SUFFIX_ADVANCED));
    	register(registry, new SpellTome(SpellTome.TomeStyle.COMBAT).setRegistryName(SpellTome.ID_PREFIX + SpellTome.TomeStyle.ID_SUFFIX_COMBAT));
    	register(registry, new SpellTome(SpellTome.TomeStyle.DEATH).setRegistryName(SpellTome.ID_PREFIX + SpellTome.TomeStyle.ID_SUFFIX_DEATH));
    	register(registry, new SpellTome(SpellTome.TomeStyle.SPOOKY).setRegistryName(SpellTome.ID_PREFIX + SpellTome.TomeStyle.ID_SUFFIX_SPOOKY));
    	register(registry, new SpellTome(SpellTome.TomeStyle.MUTED).setRegistryName(SpellTome.ID_PREFIX + SpellTome.TomeStyle.ID_SUFFIX_MUTED));
    	register(registry, new SpellTome(SpellTome.TomeStyle.LIVING).setRegistryName(SpellTome.ID_PREFIX + SpellTome.TomeStyle.ID_SUFFIX_LIVING));
