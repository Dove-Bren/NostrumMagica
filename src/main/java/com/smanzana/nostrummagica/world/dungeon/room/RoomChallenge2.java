...
public class RoomChallenge2 extends StaticRoom {
	...
	public RoomChallenge2() {
		super(ID, -16, -1, 0, 4, 9, 20,
				...
				'4', new StaticBlockState(NostrumBlocks.singleSpawner.getState(SingleSpawnerBlock.Type.GOLEM_NEUTRAL)),
	...
	public List<DungeonRoomExit> getExits(BlueprintLocation start) {
		...
		list.add(new DungeonRoomExit(NostrumOverworldDungeon.asRotated(start, exit, Direction.EAST), DungeonExitData.EMPTY));
